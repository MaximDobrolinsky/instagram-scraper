...
class InstaTouch {
    constructor({ url, download = false, filepath = '', filename = '', filetype, input, count, proxy, session, mediaType = 'all', scrapeType, asyncDownload, userAgent, progress = false, store_history = false, timeout, cli, endCursor, bulk = false, historyPath, zip = false, extractVideoUrl = true, }) {
        this.zip = zip;
        this.url = url;
