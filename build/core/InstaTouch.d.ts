...
export declare class InstaTouch {
    ...
    private zip;
    private itemCount;
    constructor({ url, download, filepath, filename, filetype, input, count, proxy, session, mediaType, scrapeType, asyncDownload, userAgent, progress, store_history, timeout, cli, endCursor, bulk, historyPath, zip, extractVideoUrl, }: Constructor);
